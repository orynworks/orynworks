...
const SAMPLES: SeedCapability[] = [
  {
    slug: "aeon-research-pack",
    type: "skill",
    name: "Aeon Research Pack",
    description:
      "Wrapper around the Aeon framework's research toolchain: deep-dive a topic, summarize across 10+ sources, structure findings with citations.\n\nReturns markdown with quoted excerpts and source URLs.",
    category: "knowledge",
    hostUrl: "https://aeon.example.com/mcp/research-pack",
    priceUsdc: "0.015",
    tokenGated: false,
    status: "published",
    version: "1.2.0",
